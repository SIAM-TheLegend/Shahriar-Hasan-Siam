  ...
  return (
    <section className="w-4/5 py-2 mx-auto">
      ...
      <form onSubmit={handleSubmit} className="contact-message-to-me">
        <fieldset>
          <legend className="text-left ml-5 px-2 border-x-2">Name:</legend>
          <input name="name" type="text" placeholder="Insert your name" required />
        </fieldset>
        <fieldset>
          <legend className="text-left ml-5 px-2 border-x-2">Email:</legend>
          <input name="email" type="email" placeholder="Insert your email" required />
        </fieldset>
        <fieldset>
          <legend className="text-left ml-5 px-2 border-x-2">Message:</legend>
          <textarea className="-mb-1 pt-2 ml-4 h-48 rounded-xl outline-none bg-transparent w-[calc(100%-16px)]" name="message" type="textarea" placeholder="Feel free to write me a message" required />
        </fieldset>
